...
type TaskDeletedConfirmationProps = {
  taskData: DeleteTaskToolInput & { id: string }
}

function TaskDeletedConfirmation({ taskData }: TaskDeletedConfirmationProps) {
  ...
  return (
    <Card
      ...
      aria-label={`Task Deleted: ${taskData.title}`}
    >
      <CardHeader className="flex items-start justify-between gap-3">
        <div className="space-y-1">
          ...
          <Typography affects={["muted", "small"]}>Task has been permanently deleted</Typography>
        </div>
...
export { TaskDeletedConfirmation }
