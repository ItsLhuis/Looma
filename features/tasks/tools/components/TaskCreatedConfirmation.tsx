...
type TaskCreatedConfirmationProps = {
  taskData: CreateTaskToolInput & { id: string }
}

function TaskCreatedConfirmation({ taskData }: TaskCreatedConfirmationProps) {
  ...
  return (
    <Card
      ...
      aria-label={`Task Created: ${taskData.title}`}
    >
      <CardHeader className="flex items-start justify-between gap-3">
        <div className="space-y-1">
          ...
          <Typography affects={["muted", "small"]}>Task has been successfully created</Typography>
        </div>
...
export { TaskCreatedConfirmation }
