...
type EventCreatedConfirmationProps = {
  eventData: CreateEventToolInput & { id: string }
}

function EventCreatedConfirmation({ eventData }: EventCreatedConfirmationProps) {
  ...
  return (
    <Card
      ...
      aria-label={`Event Created: ${eventData.title}`}
    >
      <CardHeader className="flex items-start justify-between gap-3">
        <div className="space-y-1">
          ...
          <Typography affects={["muted", "small"]}>Event has been successfully created</Typography>
        </div>
...
export { EventCreatedConfirmation }
