...
void main() {
  ...
  gl_FragColor  = color;
      ...
      const loop = (t: number) => {
        ...
        currentUniforms.iTime.value = t * 0.001
        ...
        if (followMouse && mouseInfluence > 0.0) {
          ...
          currentUniforms.mousePos.value = [smoothMouseRef.current.x, smoothMouseRef.current.y]
        }

        try {
          renderer.render({ scene: currentMesh })
  ...
  return (
    <div
      ref={containerRef}
      className={cn("pointer-events-none relative z-[3] h-full w-full overflow-hidden", className)}
    />
  )
}
