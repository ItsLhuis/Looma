...
import { getDashboardStats } from "@/features/dashboard/api/dal"

import type { GetDashboardStatsRequest } from "@/features/dashboard/api/types"

export async function GET(request: NextRequest) {
  try {
    const { searchParams } = new URL(request.url)

    const filters: GetDashboardStatsRequest = {}
